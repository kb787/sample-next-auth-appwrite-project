...
export default function Signup () {
    ...
    return (
       ...
       <h5 className = "text-2xl text-center font-serif">{loading ? "Processing":"Complete your registration"}</h5>
        ...
        <br/>
        <button className = 'bg-blue-500 rounded-md w-28 h-12 text-xl text-white flex justify-center items-center mx-auto' onClick={handleSignUp}>Register</button>
        <Link href = "/signin" className = "py-2.5 text-center">Already a user ! signin here</Link>
    </div>
</div>
    )
}
